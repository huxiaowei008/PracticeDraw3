...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text1, 100, middle + yf1, paint2);
        canvas.drawText(text2, 200, middle + yf2, paint2);
        canvas.drawText(text3, 300, middle + yf3, paint2);
        canvas.drawText(text4, 400, middle + yf4, paint2);
        canvas.drawText(text5, 500, middle + yf5, paint2);
        canvas.drawText(text6, 600, middle + yf6, paint2);
    }
}